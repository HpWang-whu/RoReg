...
#Train Args
#special
Train_Args.add_argument("--backbone_w",type=str,default=f"./checkpoints/{backbone}/GF/model_best.pth",
                        help="Training tuples (station,pc0,pc1,pt0,pt1)")
#general
Train_Args.add_argument("--part",type=str,default="ET",
                        help="short name(generating trainset for which component)")
Train_Args.add_argument("--trainset",type=str,default="3dm_train_rot",
                        help="train dataset name")
Train_Args.add_argument("--loss_type",type=str,default="loss_et",
                        help="loss type")
Train_Args.add_argument("--val_type",type=str,default="val_et",
                        help="val_type")
Train_Args.add_argument("--trainset_type",type=str,default="dataset_et",
                        help="trainset_type")
